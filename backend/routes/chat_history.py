...
def get_chat_history():
    ...
    Parameters:
        room_id (str): The id of the room to get the chat history for.

    Returns:
        list: A list of chat history messages, each containing the message_id, room_id, user_name, message, and create_date of the message.
