	...
	return (
		<div className="min-h-screen justify-between items-center overflow-hidden">
			...
			<div className="flex-1 self-stretch px-32 bg-white inline-flex flex-col justify-center items-center gap-16">
				<div className="self-stretch justify-start text-[#6D66D2] text-8xl font-normal font-['Inter']">Zaloguj się</div>
				...
				<Button label="Zaloguj się" onClick={() => {router.push("/dashboard");}} />
				<div className="self-stretch inline-flex justify-center items-center gap-4">
					<div className="flex-1 h-1 bg-[#ACD266] rounded-lg" />
					<div className="justify-start text-black text-xl font-normal font-['Inter']">Nie masz konta?</div>
					<div className="flex-1 h-1 bg-[#ACD266] rounded-lg" />
				</div>
				<Button label="Zarejestruj się" onClick={() => {router.push("/rejestracja");}} type="outline" />
			</div>
		</div>
	);
}
